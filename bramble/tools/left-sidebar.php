        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
					...
					<li class="nav-item">
                                            <a class="nav-link" href="index.php"><i class="fas fa-fw fa-seedling"></i>Dashboard</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="console.php"><i class="fas fa-fw fa-terminal"></i>Bramble console</a>
                                        <li class="nav-item">
                                        </li>
                                        <li class="nav-item">
